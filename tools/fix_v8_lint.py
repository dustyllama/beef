...
# RequiresOptIn marker. Opt the package in with androidx.annotation.OptIn,
# exactly as Media3 documents, rather than suppressing lint globally.
...
package_info.write_text('''@file:OptIn(UnstableApi::class)\npackage com.neurontap.app\n\nimport androidx.annotation.OptIn\nimport androidx.media3.common.util.UnstableApi\n''')
